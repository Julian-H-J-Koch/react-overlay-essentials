...
// Um das InfoOverlayWithInput zu nutzen, muss der State die folgende Struktur haben:
const defaultInformationState : InfoOverlayWithInputState = {
    headline: undefined,
    message: undefined,
    preInput: undefined,
...
function InfoOverlayWithInput({ state, setState }: { state: InfoOverlayWithInputState, setState: (state: InfoOverlayWithInputState) => void }): React.ReactElement {
